...
Tracking.model.base = function(){
    ...
    var _getAppartementDetails = function(callBack){
        xhrService.getMethod('/appartementDetails',function(res){
            _appartement = new Tracking.model.appartement(xhrService,res);
            callBack();
        });
    };
    ...
    return {
        ...
        logout:_logout,
        getView:_getView,
        getAppartementDetails:_getAppartementDetails,
        getAppartmentModel:function(){
            return _appartement;
        },
...
Tracking.model.appartement = function(xhr,data){

    var appartementModel = function(data){
        var _data = data;
        return{
            getId:function(){
                return _data._id;
    ...
    var _appartement = new Tracking.model.ArrayList(appartementModel,data);

    return{
        addAppartement:function(data,callBack){
            xhr.postMethod('/saveAppartement',data,function(res){
                _appartement.add(res);
                callBack(res);
            })
        },
        deleteAppartement:function(data,callBack){
            xhr.postMethod('/deleteAppartement',{id:data.getId()},function(res){
                _appartement.remove(data);
                callBack(res);
            })
        },
        getAppartement:function(){
            return _appartement.toArray();
        }
